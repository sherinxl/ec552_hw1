...
def modify_signal(option_list,input_sensor_file_path,modified_signal_file_path):
    ...
    file = open(modified_signal_txt_file,'w')

    with open(input_sensor_file_path, 'rb') as f:
    ...
    file = open(modified_signal_txt_file,'r')
...
def modify_gate(option_list,input_gate_file_path,modified_gate_file_path):
    ...
    file = open(modified_gate_txt_file,'w', encoding = "utf-8")

    with open(input_gate_file_path, 'rb') as f:
    ...
    file = open(modified_gate_txt_file,'r', encoding = "utf-8")
    lines = file.readlines()
    data_list = list()
    for line in lines:
        data = ast.literal_eval(line)
